...
font = pygame.font.SysFont(None, 55)            #---(Default font, size)
def text_screen(text, color, x, y):
    screan_text = font.render(text, , color)
...
#------------
    if abs(snake_x - food_x)<10 and abs(snake_y - food_y)<10:
        ...
        food_x = random.randint(5, screan_width-15)
        food_y = random.randint(5, screan_height-15) 
